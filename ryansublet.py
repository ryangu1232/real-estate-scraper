...
#full url with location
url = f"https://sublet.com/apartments-for-rent/{location}?items_offset={page_number}"
...
description_div = market_soup.find_all('span', class_= "float-right supply-details-link text-black")
description_list = [description.text.strip() for description in description_div]
#finds the prices [DONE]
prices_div = market_soup.find_all('span', class_="col-12 font")
...
df.to_csv('subletlistings.csv', index=False, encoding='utf-8')
